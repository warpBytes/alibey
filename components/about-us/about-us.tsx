    ...
    <div className="flex flex-col gap-[120px]">
      ...
      <div className="content-wrapper mt-20 md:mt-0">
        <div className="flex w-full flex-wrap-reverse justify-between gap-10 md:gap-4">
          <div className="mx-auto flex max-w-[708px] flex-col gap-6">
            <SectionHeading
              title="About us"
              className="mx-auto md:mx-0 md:mb-4"
            />
        ...
        <div className="mt-[120px] flex flex-col justify-center gap-[120px] md:mt-[80px] md:gap-[80px]">
          <div className="mx-auto flex flex-col items-center justify-between gap-6 md:mx-0">
            <span className="max-md:text-neutral600 md:text-2xl">
              Working hours:
            </span>
